...
# Актуальные данные RZS (Цены / 3, Охват 2024-2025)
STATION_DATA = {
...
TIME_SLOTS_DATA = [
    {"time": "06:00-07:00", "label": "Подъем, сборы", "weight": 0.06, "premium": False},
    {"time": "07:00-08:00", "label": "Утренние поездки", "weight": 0.10, "premium": True},
    {"time": "08:00-09:00", "label": "Пик трафика", "weight": 0.12, "premium": True},
    {"time": "09:00-10:00", "label": "Начало работы", "weight": 0.08, "premium": True},
    {"time": "10:00-11:00", "label": "Рабочий процесс", "weight": 0.07, "premium": False},
    {"time": "11:00-12:00", "label": "Предобеденное время", "weight": 0.06, "premium": False},
    {"time": "12:00-13:00", "label": "Обеденный перерыв", "weight": 0.05, "premium": False},
    {"time": "13:00-14:00", "label": "После обеда", "weight": 0.05, "premium": False},
    ...
    {"time": "16:00-17:00", "label": "Конец рабочего дня", "weight": 0.07, "premium": False},
    {"time": "17:00-18:00", "label": "Вечерние поездки", "weight": 0.10, "premium": True},
    {"time": "18:00-19:00", "label": "Пик трафика", "weight": 0.08, "premium": True},
    {"time": "19:00-20:00", "label": "Домашний вечер", "weight": 0.04, "premium": False},
    {"time": "20:00-21:00", "label": "Вечерний отдых", "weight": 0.04, "premium": False}
]
...
def calculate_campaign_price_and_reach(data):
    try:
        ...
        # Базовая стоимость без наценок за премиум (они у нас в цене секунды)
        air_cost = base_sec * duration * len(slots) * days * vol_discount
        
        # БОНУС: 15 слотов = -5% скидка
        applied_discount = 0
        if len(slots) == 15:
            air_cost *= 0.95
            applied_discount = 5
        ...
        # 2. Производство
        p_costs = {"standard": 5000, "premium": 12500, "none": 0}
        total_price = max(int(air_cost) + p_costs.get(prod_option, 0), 7000)

        # 3. Охват (0.7 уникальность)
