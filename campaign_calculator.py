...
# Цены делены на 3. Охват Mediascope 2024-2025 (Тюмень).
STATION_DATA = {
...
TIME_SLOTS_DATA = [
    ...
    {"time": "07:00-08:00", "label": "Утренние поездки", "weight": 0.12},
    {"time": "08:00-09:00", "label": "Пик трафика", "weight": 0.15}, 
    {"time": "09:00-10:00", "label": "Начало работы", "weight": 0.09},
    ...
    {"time": "16:00-17:00", "label": "Конец рабочего дня", "weight": 0.08}, 
    {"time": "17:00-18:00", "label": "Вечерние поездки", "weight": 0.12},
    {"time": "18:00-19:00", "label": "Пик трафика", "weight": 0.10}, 
